...
class Task:
    ...
    def average(self):
        return round(sum(self.durations)/len(self.durations),2)
...
def get_log_values(log_file):
    ...
    for key, task in tasks.items():
        print(task.name + "" + str(task.average()) + ";" + str(task.min()) + ";" + str(task.max()))
        #print(task.name + " avg " + str(task.average()) + " ms,"+ " min " + str(task.min()) + " ms,"+ " max " + str(task.max()) + " ms")
        #return task.name + " avg " + str(task.average()) + " ms,"+ " min " + str(task.min()) + " ms,"+ " max " + str(task.max()) + " ms"
